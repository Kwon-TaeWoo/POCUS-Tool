    ...
    public static class GraphHelper
    {
            ...
            int maxPoints = 40)
        {
            ...
            try
            {
                ...
                // 최근 N개 포인트만 표시
                var recentCac = cacValues.Skip(Math.Max(0, cacValues.Count - maxPoints)).ToList();
                var recentIjv = ijvValues.Skip(Math.Max(0, ijvValues.Count - maxPoints)).ToList();
        ...
        public static void ClearGraphData(params Series[] series)
        {
            ...
            try
            {
                foreach (var s in series)
                {
                    ...
                    else if (s is ScatterSeries scatterSeries)
