...
namespace ROSC.WPF.Services
{
    ...
    public class ImageProcessingService
    {
        ...
        /// </summary>
        public Mat ImageScaling(Mat oriImg, Size imgSize, InterpolationFlags interpolation = InterpolationFlags.Area)
        {
            return ExceptionHelper.SafeExecute(() =>
            {
        ...
        /// </summary>
        public Mat PreprocessForModel(Mat inputImage, Size targetSize)
        {
            return ExceptionHelper.SafeExecute(() =>
            {
        ...
        /// CLAHE 적용
        /// </summary>
        public Mat ApplyCLAHE(Mat inputImage, double clipLimit = 2.0, Size tileGridSize = default)
        {
        ...
        public Mat AddTextToImage(Mat image, string frameInfo, string classInfo, string cacInfo)
        {
            return ExceptionHelper.SafeExecute(() =>
            {
                ...
                var texts = new[]
                {
                    (frameInfo, new Point(10, 20)),
                    (classInfo, new Point(10, 40)),
                    (cacInfo, new Point(10, 60))
                };
